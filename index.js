...
// ;(async () => {
    // let currency2 =await Currency.create({ currencyName: "Украинская гривна", currencySymbol: "UAH" })
//     let currency =await Currency.create({ currencyName: "Евро", currencySymbol: "EUR" })
//     let currency1 =await Currency.create({ currencyName: "Американский доллар", currencySymbol: "USD" })
...
// console.log("ANNOUNCEMENT PROTOTYPE  :",Announcement.prototype)